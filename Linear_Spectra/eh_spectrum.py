...
plt.plot(1000*np.linspace(E_start,E_stop,energyresolution),alpha_eh_coulomb, label = 'Matrix inversion coulomb')
...
plt.legend()
plt.savefig('results/absorption_linear_eh_Qmax={}_Qdim={}.pdf'.format(Qmax, Qdim))
